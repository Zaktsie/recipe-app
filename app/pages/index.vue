...
<template>
  <main>
    <!-- Hero Section -->
    <section class="bg-[#f1f1f1] dark:bg-gray-800/30">
      <div class="container flex flex-col lg:flex-row items-center py-20 gap-10">
        <div class="flex-1 order-2 lg:order-1 text-center lg:text-left">
          <h1 class="text-4xl lg:text-6xl font-extrabold mb-6 text-balance leading-tight dark:text-white">
            Master the Kitchen with Ease: Unleash Your Inner Chef!
          </h1>
          <p class="text-xl lg:text-2xl mb-8 text-balance text-gray-700 dark:text-gray-300">
            Explore thousands of easy-to-follow recipes today.
          </p>
          <NuxtLink
            to="#recipes"
            class="px-8 py-3 text-white bg-apple-green rounded-md text-xl font-bold hover:bg-opacity-90 transition-all inline-block"
          >
            Browse Recipes
          </NuxtLink>
        </div>
    ...
    <section id="recipes" class="py-12 container border-b dark:border-gray-800">
      <div class="flex flex-col md:flex-row gap-6 items-end justify-between">
        <div class="w-full md:max-w-md">
          <label class="block text-lg font-bold mb-2 dark:text-white">Search Recipes</label>
          <div class="relative">
            <input
              v-model.lazy="searchQuery"
              type="text"
              placeholder="e.g. Pasta, Pizza..."
              class="w-full px-4 py-3 rounded-md border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-apple-green focus:outline-none pl-10"
            />
        ...
        <div class="w-full md:max-w-xs">
          <label class="block text-lg font-bold mb-2 dark:text-white">Filter by Category</label>
          <select
            v-model="selectedTag"
            class="w-full px-4 py-3 rounded-md border border-gray-300 dark:border-gray-700 dark:bg-gray-800 dark:text-white focus:ring-2 focus:ring-apple-green focus:outline-none bg-white"
          >
    ...
    <section class="py-20 container">
      <div class="mb-12">
        <h2 class="text-3xl lg:text-5xl font-extrabold mb-2 dark:text-white">
